...
INSERT INTO compute_rates (
    currency_code, money_changer_id, unit, raw_bid, raw_ask, spread, skew,
    ws_bid, ws_ask, ref_bid, dp_bid, mar_bid, cf_bid, rt_bid,
    ref_ask, dp_ask, mar_ask, cf_ask, rt_ask,
    processed_at, processed_by
) VALUES
-- Money Changer 1
('USD', 1, '1', 1.2755, 1.2773, 0.0018, 0.0005, 1.2758, 1.2770, 1.2760, 1.2761, 1.2762, 1.2763, 1.2764, 1.2772, 1.2771, 1.2770, 1.2769, 1.2768, CURRENT_TIMESTAMP, 1),
('EUR', 1, '1', 1.5018, 1.5036, 0.0018, 0.0004, 1.5021, 1.5033, 1.5024, 1.5025, 1.5026, 1.5027, 1.5028, 1.5035, 1.5034, 1.5033, 1.5032, 1.5031, CURRENT_TIMESTAMP, 1),
('SGD', 1, '1', 0.9998, 1.0002, 0.0004, 0.0002, 0.9999, 1.0001, 1.0000, 1.0000, 1.0000, 1.0000, 1.0000, 1.0002, 1.0001, 1.0001, 1.0001, 1.0001, CURRENT_TIMESTAMP, 1),
('MYR', 1, '1', 0.3012, 0.3018, 0.0006, 0.0003, 0.3013, 0.3017, 0.3014, 0.3015, 0.3015, 0.3015, 0.3016, 0.3018, 0.3017, 0.3016, 0.3016, 0.3015, CURRENT_TIMESTAMP, 1),
('IDR', 1, '1000', 0.0784, 0.0788, 0.0004, 0.0001, 0.0785, 0.0787, 0.0786, 0.0786, 0.0786, 0.0786, 0.0786, 0.0788, 0.0787, 0.0787, 0.0787, 0.0787, CURRENT_TIMESTAMP, 1),

-- Money Changer 2
('USD', 2, '1', 1.2752, 1.2774, 0.0022, 0.0006, 1.2755, 1.2771, 1.2758, 1.2759, 1.2760, 1.2761, 1.2762, 1.2773, 1.2772, 1.2771, 1.2770, 1.2769, CURRENT_TIMESTAMP, 1),
('EUR', 2, '1', 1.5015, 1.5039, 0.0024, 0.0005, 1.5018, 1.5036, 1.5021, 1.5022, 1.5023, 1.5024, 1.5025, 1.5038, 1.5037, 1.5036, 1.5035, 1.5034, CURRENT_TIMESTAMP, 1),
('MYR', 2, '1', 0.3013, 0.3017, 0.0004, 0.0002, 0.3014, 0.3016, 0.3015, 0.3015, 0.3015, 0.3015, 0.3015, 0.3017, 0.3016, 0.3016, 0.3016, 0.3016, CURRENT_TIMESTAMP, 1),
('IDR', 2, '1000', 0.0783, 0.0789, 0.0006, 0.0002, 0.0784, 0.0788, 0.0785, 0.0786, 0.0786, 0.0786, 0.0786, 0.0789, 0.0788, 0.0787, 0.0787, 0.0786, CURRENT_TIMESTAMP, 1),
('VND', 2, '100000', 5.2950, 5.3050, 0.0100, 0.0010, 5.2970, 5.3030, 5.2980, 5.2990, 5.3000, 5.3010, 5.3020, 5.3040, 5.3030, 5.3020, 5.3010, 5.3000, CURRENT_TIMESTAMP, 1),

-- Money Changer 3
('USD', 3, '1', 1.2750, 1.2770, 0.0020, 0.0004, 1.2753, 1.2767, 1.2756, 1.2757, 1.2758, 1.2759, 1.2760, 1.2769, 1.2768, 1.2767, 1.2766, 1.2765, CURRENT_TIMESTAMP, 1),
('SGD', 3, '1', 0.9999, 1.0001, 0.0002, 0.0001, 1.0000, 1.0000, 1.0000, 1.0000, 1.0000, 1.0000, 1.0000, 1.0001, 1.0001, 1.0001, 1.0001, 1.0001, CURRENT_TIMESTAMP, 1),
('TWD', 3, '100', 4.1950, 4.2050, 0.0100, 0.0010, 4.1970, 4.2030, 4.1980, 4.1990, 4.2000, 4.2010, 4.2020, 4.2040, 4.2030, 4.2020, 4.2010, 4.2000, CURRENT_TIMESTAMP, 1),
('MYR', 3, '1', 0.3014, 0.3016, 0.0002, 0.0001, 0.30145, 0.30155, 0.30146, 0.30147, 0.30148, 0.30149, 0.30150, 0.30152, 0.30151, 0.30150, 0.30149, 0.30148, CURRENT_TIMESTAMP, 1),
('VND', 3, '100000', 5.2930, 5.3070, 0.0140, 0.0015, 5.2940, 5.3060, 5.2950, 5.2960, 5.2970, 5.2980, 5.2990, 5.3050, 5.3040, 5.3030, 5.3020, 5.3010, CURRENT_TIMESTAMP, 1),

-- Money Changer 4
('USD', 4, '1', 1.2749, 1.2775, 0.0026, 0.0006, 1.2751, 1.2773, 1.2753, 1.2755, 1.2757, 1.2759, 1.2761, 1.2774, 1.2773, 1.2772, 1.2771, 1.2770, CURRENT_TIMESTAMP, 1),
('TWD', 4, '100', 4.1940, 4.2060, 0.0120, 0.0015, 4.1960, 4.2040, 4.1970, 4.1980, 4.1990, 4.2000, 4.2010, 4.2050, 4.2040, 4.2030, 4.2020, 4.2010, CURRENT_TIMESTAMP, 1),
('EUR', 4, '1', 1.5010, 1.5040, 0.0030, 0.0007, 1.5015, 1.5035, 1.5020, 1.5022, 1.5024, 1.5026, 1.5028, 1.5039, 1.5038, 1.5037, 1.5036, 1.5035, CURRENT_TIMESTAMP, 1),
('IDR', 4, '1000', 0.0782, 0.0790, 0.0008, 0.0002, 0.0783, 0.0789, 0.0784, 0.0785, 0.0786, 0.0787, 0.0788, 0.07895, 0.07885, 0.07875, 0.07865, 0.07855, CURRENT_TIMESTAMP, 1),
('VND', 4, '100000', 5.2920, 5.3080, 0.0160, 0.0020, 5.2935, 5.3065, 5.2950, 5.2970, 5.2990, 5.3010, 5.3030, 5.3075, 5.3060, 5.3045, 5.3030, 5.3015, CURRENT_TIMESTAMP, 1);
