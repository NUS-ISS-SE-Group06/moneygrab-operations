...
ALTER TABLE company_commission_scheme ADD CONSTRAINT fk_company_commission_money_changer FOREIGN KEY (money_changer_id) REFERENCES money_changer(id);
ALTER TABLE company_commission_scheme ADD CONSTRAINT fk_company_commission_rate FOREIGN KEY (commission_rate_id) REFERENCES commission_rate(id);
ALTER TABLE company_commission_scheme ADD CONSTRAINT fk_company_commission_created_by FOREIGN KEY (created_by) REFERENCES accounts(id);
ALTER TABLE company_commission_scheme ADD CONSTRAINT fk_company_commission_updated_by FOREIGN KEY (updated_by) REFERENCES accounts(id);

ALTER TABLE money_changer_photo ADD CONSTRAINT fk_photo_money_changer FOREIGN KEY (money_changer_id) REFERENCES money_changer(id) ON DELETE CASCADE;
ALTER TABLE money_changer_photo ADD CONSTRAINT fk_photo_created_by FOREIGN KEY (created_by) REFERENCES accounts(id);
ALTER TABLE money_changer_photo ADD CONSTRAINT fk_photo_updated_by FOREIGN KEY (updated_by) REFERENCES accounts(id);

ALTER TABLE commission_rate ADD CONSTRAINT fk_commission_created_by FOREIGN KEY (created_by) REFERENCES accounts(id);
ALTER TABLE commission_rate ADD CONSTRAINT fk_commission_updated_by FOREIGN KEY (updated_by) REFERENCES accounts(id);
